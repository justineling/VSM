...
if(isset($_GET["Submit"])){
	...
	$query2 = "INSERT INTO vehicle (vehicle_id,plate_no,engine_no,brand,last_service,model_type,mileage,owner,colour,cc) 
				VALUES ('','".$plate_no."','".$engine_no."','".$brand."','".$last_service."','".$model_type."','".$mileage."','".$owner."','".$colour."','".$cc."')";
