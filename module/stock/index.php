	...
	<div class="row row2">
		<div class="col-12 title">
            ...
            <div style="float:left">
                <a type="button" class="btn btn-grey" style="background-color:#008ae6;" href="../main/mainIndex.php?page=stock">STOCK</a>&nbsp;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#register tfoot th').not(":eq(0), :eq(1), :eq(13)").each( function () {
            var title = $(this).text();
