...
<body>
  <nav class="navbar navbar-dark sticky-top flex-md-nowrap p-0">
    <a class="navbar-brand " style="width: 500px; text-align: center;" href="#"><h1>VSM</h1><!--<img src="../include/icon/logo.png" width="auto" height="auto">--></a>
  ...
  <div class="container-fluid">
    <div class="row rows">
      <nav class=" d-none d-md-block sidebar" style="padding:0;">
