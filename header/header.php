...
<body>
  <nav class="navbar navbar-dark sticky-top flex-md-nowrap p-0" style="background-image: linear-gradient(to right, #2357a0)">
    <a class="navbar-brand col-md-1 mx-auto" style="width:180px; text-align: center;" href="#"><h2>VMS</h2></span></a>
    <div class="w-100 h-100" style="font-size:11px;color:#000000;">
      <div class="ml-5 mt-3">
        <div style="float:left;" class="col-md-12">
          <a class="icon-img" style="width:120px; border-right: 2px solid lightgray;padding-right: 10px; text-decoration: none;color:#000000;" href="mainIndex.php?page=customer">
            <b style="color: white;"><img src="../include/icon/header1/CUSTOMERS(WHITE).png" style="width: 40px; height: 40px;">CUSTOMER</b>
          </a>
          <a class="icon-img" style="width:120px; border-right: 2px solid lightgray; padding-left: 10px; padding-right: 10px;text-decoration: none;color:#000000;" href="mainIndex.php?page=vehicle"> 
            <b style="color: white"><img src="../include/icon/header1/VEHICLE(WHITE).png" style="width: 40px; height: 40px;"> VEHICLE</b>
          </a>
          <a class="icon-img" style="width:150px; border-right: 2px solid lightgray; padding-left: 10px; padding-right: 10px;text-decoration: none;color:#000000;" href="mainIndex.php?page=appointment"> 
            <b style="color: white"><img src="../include/icon/header1/APPOINTMENT(WHITE).png" style="width: 40px; height: 40px;"> APPOINTMENT</b>
          </a>
          ...
          <a class="icon-img" style="width:140px; border-right: 2px solid lightgray; padding-left: 10px; padding-right: 10px;text-decoration: none;color:#000000;" href="mainIndex.php?page=parts"> 
            <b style="color: white"><img src="../include/icon/header1/PARTS(WHITE).png" style="width: 40px; height: 40px;"> INVENTORY</b>
          </a>
          <a class="icon-img" style="width:120px; border-right: 2px solid lightgray; padding-left: 10px; padding-right: 10px;text-decoration: none;color:#000000;" href="mainIndex.php?page=report"> 
            <b style="color: white"><img src="../include/icon/header1/REPORT(WHITE).png" style="width: 40px; height: 40px;"> REPORT</b>
          </a>

          
           

           <a class="dropbtn" style="padding-right:  10px; text-decoration: none; float: right" href="#"><span id="name" style="color:#40E0D0; font-size: 12px;">Softworld</span> &nbsp;&nbsp;<img src="../include/icon/header1/CUSTOMERS(WHITE).png" >
          ...
          <!-- <div class="dropdown-content">
              <a href="mainIndex.php?page=profile_edit&id=<?php echo ($id); ?>" style="font-size: 15px;">Edit profile</a>
      ...
      <?php 
        ...
        else if ($page == 'add_billing') {
              include "../module/add_billing/index.php"; 
            }
        else if ($page == 'edit_billing') {
              include "../module/edit_billing/index.php"; 
            }
        else if ($page == 'parts') {
